        ...
        return (
            <div>
                ...
                <div className="row no-gutter">
                    <div className="col-12 title-section">
                        <ScrollAnimation {...settings} animateIn="fadeInUp">
                            <h1><FormattedMessage id="nav.workshop"/></h1>
                        </ScrollAnimation>
                    </div>
                </div>
                {/*-----------------second type -------*/}
                <div className="row no-gutter flex-wrap">
                    ...
                    <div
                        className="d-flex col-lg-6 col-md-6 col-sm-10 col-10  bg-white  flex-column justify-content-center">
                        <span className="spacer"></span>
                        <ScrollAnimation {...settings} animateIn="fadeInUp">
                        <p className="view-section-p"><FormattedMessage id="workshop.p1"/></p>
                        <p className="view-section-p"><FormattedMessage id="workshop.p2"/></p>
                        <p className="view-section-p"><FormattedMessage id="workshop.p3"/></p>
                        <p className="view-section-p"><FormattedMessage id="workshop.p4"/></p>
                        <p className="view-section-p"><FormattedMessage id="workshop.p5"/></p>
                        </ScrollAnimation>
                        <span className="spacer"></span>
                    </div>
